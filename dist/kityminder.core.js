/*!
 * ====================================================
 * Kity Minder Core - v1.4.50 - 2019-04-15
...
_p[56] = {
    value: function(require, exports, module) {
        ...
        Module.register("PriorityModule", function() {
            ...
            [ "#80acb4", "#515151" ], [ "#83989b", "#515151" ], [ "#8e9698", "#515151" ] ];
            // hue from 1 to 5
            // jscs:disable maximumLineLength
            ...
            var PriorityIcon = kity.createClass("PriorityIcon", {
                ...
                create: function() {
                    ...
                    number = new kity.Text().setX(this.width / 2).setY(this.height / 2 - 1).setTextAnchor("middle").setVerticalAlign("middle").setFontSize(12).setFontBold(true).fill("white");
